...
//  friend class ::RoutingProtocol;
  ...
  */
  ...
  std::map<Ipv4Address, std::vector<Ipv4Address>> sink_candidate_addr;
...
private:
  ...
  */
  void PacketReceived (const Ptr<Packet> &p, const Address &from, const Address &localAddress, const Ipv4Address &senderIface);
  ...
  */
   ...
   */
   ...
   TracedCallback<Ptr<const Packet>, const Address &, const Address &, const SimulationHeader&> m_rxTraceWithSeqTsSize2;
    //パケット受信に関するもの(ここまで)
