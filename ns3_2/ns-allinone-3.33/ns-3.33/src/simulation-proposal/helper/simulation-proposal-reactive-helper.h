...
#ifndef SIMULATION_PROPOSAL_REACTIVE_HELPER_H
#define SIMULATION_PROPOSAL_REACTIVE_HELPER_H
 ...
 * on a set of nodes.
 */
class SimulationProposalReactiveHelper
{
public:
  /**
...
#endif /* SIMULATION_PROPOSAL_REACTIVE_HELPER_H */
