 ...
 */
#ifndef OLSR_HELPER_SEED_H
#define OLSR_HELPER_SEED_H
 ...
 */
class OlsrHelperSeed : public Ipv4RoutingHelper
{
public:
  /**
...
//  std::map<Ptr<Node>, Address> GetThreshold (Ptr<Node> node);
  ...
  void Add (const OlsrHelperSeed &routing, int16_t priority);
...
private:
   ...
   * \return nothing
   */
  OlsrHelperSeed &operator = (const OlsrHelperSeed &);
  ObjectFactory m_agentFactory; //!< Object factory


  std::list<std::pair<const OlsrHelperSeed *,int16_t> > m_list;
