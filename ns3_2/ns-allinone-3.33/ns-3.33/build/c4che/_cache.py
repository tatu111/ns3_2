...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.8-WxaceB/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.8-WxaceB/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.8-WxaceB/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.8-WxaceB/python3.8-3.8.10=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['socket', 'tcp', 'stats', 'naming', 'realtime', 'routing', 'tutorial', 'traffic-control', 'channel-models', 'error-model', 'wireless', 'energy', 'ipv6', 'udp-client-server', 'matrix-topology', 'udp']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/home/ueda/document/ns3_2/ns-allinone-3.33/ns-3.33/build/lib', '/home/ueda/document/ns3_2/ns-allinone-3.33/ns-3.33/build']
...
cfg_files = ['/home/ueda/document/ns3_2/ns-allinone-3.33/ns-3.33/build/ns3/config-store-config.h', '/home/ueda/document/ns3_2/ns-allinone-3.33/ns-3.33/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
